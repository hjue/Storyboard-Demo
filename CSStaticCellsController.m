...
#import "CSStaticCellsController.h"

@interface CSStaticCellsController ()

@end

@implementation CSStaticCellsController
...
-(IBAction)returned:(UIStoryboardSegue *)segue {
    NSLog(@"return CSStaticCellsController! ");
    _btnPress.titleLabel.text = @"Returned from Scene ";
}
*/
